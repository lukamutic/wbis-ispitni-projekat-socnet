...
// }
  ...
  // funkcionalnost za zamenu grafika na klik event
  var toggleButton = document.getElementById("toggle-button");
  toggleButton.addEventListener("click", function () {
    var chart01 = document.querySelector(".chart-01");
    var chart02 = document.querySelector(".chart-02");
    chart01.classList.toggle("d-none");
    chart02.classList.toggle("d-none");
  });